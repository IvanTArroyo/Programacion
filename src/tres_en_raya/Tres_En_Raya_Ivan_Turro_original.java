...
public class Tres_En_Raya_Ivan_Turro_original {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				}while ((quedanCasillas()==true)&&(!ganaJugador1())&&(!ganaJugador2()));
				...
				if (ganaJugador1()==true) {
					...
					gan1++;
					//si gana jugador dos mostramos mensaje  guardamos en un contador las partidas ganadas por el jugador dos
				}if (ganaJugador2()==true) {
					System.out.println("Ha ganado jugador 2.");
					gan2++;
				//si no gana ninguno de los dos, es empate	
